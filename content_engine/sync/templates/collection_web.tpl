...
<a class="btn" href="{{ game.android_download_url }}" style="margin-top:10px;"><i class="icon-download-alt"></i>下载安卓版</a>
{% else %}
<a class="btn disabled" href="#" style="margin-top:10px;"><i class="icon-download-alt icon-white"></i>无安卓版</a>
{% endif %}
{% if game.iOS_download_url %}
<a class="btn" href="{{ game.iOS_download_url }}" style="margin-top:10px;"><i class="icon-download-alt"></i>下载苹果版</a>
{% else %}
