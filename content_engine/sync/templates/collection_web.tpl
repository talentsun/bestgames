...
[col grid="4-1"]
<a class="btn btn-success" rel="lightbox" href="http://qrickit.com/api/qr?qrsize=300&d=http://cow.bestgames7.com/games/{{ game.id }}/preview"><i class="icon-qrcode icon-white"></i>二维码下载</a>
